...
export class Note {
    ...
    get ListTemplate() {
        return /*html*/`
        <div class="col-12 p-2 selectable" onclick="app.notesController.setActive('${this.iD}')">
        <div class="row">
        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">edit</button>
          <div class="col-1"><i class="mdi mdi-music"></i></div>
          <div class="col-6">${this.name}</div>
          <div class="col-5"><h6>${this.createdAt}</h6></div>
        </div>
      </div>
        `
    }
